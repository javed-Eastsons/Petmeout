          ...
          >
            <View
              ...
              <TouchableOpacity
                ...
                <Text style={[styles.client, { alignSelf: 'center', marginLeft: 5, fontFamily: 'Poppins-Bold', fontSize: 13, marginTop: 5 }]}>New Request</Text>
              </TouchableOpacity>
              {/* <Button
            title="+ New Request"
            color="#2F4050"
                      ...
                      <View
                        ...
                        <TouchableOpacity
                          style={[
                            ...
                            {
                              backgroundColor:
                                showwhat1 == 'Message' ? '#d5e3e5' : '#d5e3e5',
                            },
                          ]}

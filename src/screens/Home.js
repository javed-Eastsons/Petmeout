...
import { View, Text, Dimensions, StyleSheet, ScrollView, TouchableOpacity, Image, Button } from 'react-native';
const HomeScreen = () => {
      ...
      <View style={styles.slideContainer}>
        <ScrollView contentContainerStyle={{ padding: 5 }} horizontal={true}>
          ...
          >
            ...
            <View style={{ padding: 5 }}>
              <Text numberOfLines={3} style={styles.sliderText}>
                Earn $50 In Your Next Order By Referring a{"\n"} Friend To Us By Using The Code FRIEND50OFF
          ...
          >
            ...
            {/* <Image source={require('../Assets/OurService.png')}
                                style={styles.Slidericons}
                            /> */}
            <Text style={styles.postText}>You Still Haven’t{"\n"} File Your Taxes?</Text>
            <View style={{ padding: 5 }}>
              <Text numberOfLines={3} style={styles.sliderText}>
          ...
          >
            ...
            <View style={{ padding: 5 }}>
              ...
              <Text style={styles.info}>Learn The Benefits of Having A US Company</Text>
              <TouchableOpacity style={styles.btn}>
                <Text style={{color:'#fff'}}>987654</Text>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  btn: {
    width: '30%', alignSelf: 'center', marginBottom: 30,
    marginTop: 10,
